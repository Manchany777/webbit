...
<!-- 주의 : 여기서의 name는 클래스 필드가 아닌 getName()이라는 함수명을 바꾼 것 뿐이다. 착각주의 
...
<h3>forEach문</h3> 
<!-- 웹에서는 자바처럼 자료형이 없기때문에 확장형 for문처럼 자료형을 적을 수가 없다. so, var에 변수명을 적어야 한다. -->
...
<!-- 따라서 items="${ requestScope.list2 }에서 requestScope를 생략해서 알아서 거슬러 올라가며 찾아준다. -->
</body>
</html>