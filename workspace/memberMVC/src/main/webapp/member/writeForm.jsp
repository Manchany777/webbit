...
<table border="1" cellpadding="5" cellspacing="0" align="center" style="border: 2px solid gray;">
    <tr>
        <th align="center" style="border: 2px solid gray;">이름</th>
    ...
    <tr>
        <th align="center" style="border: 2px solid gray;">아이디</th>
        <td style="border: 2px solid gray;">
        	<input type="text" name="id" id="id" maxlength="10" placeholder="아이디 입력" style="width: 250px;" />
        	<input type="button" value="중복체크" onclick="checkID()">
        	<input type="hidden" name="useCheckedId" id="useCheckedId" value="0" />
        	<div id="idDiv"></div>
        </td>
    </tr>
    <tr>
        <th align="center" style="border: 2px solid gray;">비밀번호</th>
        <td style="border: 2px solid gray;">
    ...
    <tr>
        <th align="center" style="border: 2px solid gray;">재확인</th>
        <td style="border: 2px solid gray;">
        	<input type="password" id="repwd" maxlength="10"  style="width: 300px;" />
        </td>
    </tr>
    <tr>
        <th align="center" style="border: 2px solid gray;">성별</th>
        <td style="border: 2px solid gray;">
    ...
    <tr>
        <th align="center" style="border: 2px solid gray;">이메일</th>
        <td style="border: 2px solid gray;">
    ...
    <tr>
        <th align="center" style="border: 2px solid gray;">휴대폰</th>
        <td style="border: 2px solid gray;">
        	<select name="tel1" id="phone_1" style="width: 60px;"> 
			 ...
			 -
			<input type="tel" name="tel2" id="phone_2" maxlength="10" style="width: 60px;"/>
			 - 
			<input type="tel" name="tel3" id="phone_3" maxlength="10" style="width: 60px;" />
        </td>
    </tr>
    <tr>
        <th align="center" style="border: 2px solid gray;">주소</th>
        <td style="border: 2px solid gray;">
        	<input type="text" name="zipcode" id="zipcode" maxlength="10" readonly/>
        	<input type="button" value="우편번호검색" id="checkPostBtn" /><br>
        	<input type="text" name="addr1" id="addr1" maxlength="10" placeholder="주소" style="width: 97%;" /><br>
        	<input type="text" name="addr2" id="addr2" maxlength="10" placeholder="상세주소" style="width: 97%;" />
        </td>
    </tr>
    <tr>
...
function checkID(){
	...
	if(id == "")
		...
		window.open("/memberMVC/member/checkId.do?id="+id+"&useCheckedId=idChecked", "checkId", "width=300 height=150 top=200 left=400 scrollbars=no toolbar=no menubar=no status=no location=no");  // 두번째 인자값 - 새창 무한증식 방지(이름자체는 아무거나 넣어도 무방)
...
<script src="http://localhost:8080/memberMVC/js/write.js"></script>
